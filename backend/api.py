...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://heat-mitigation.vercel.app", "https://heat-mitigation-production.up.railway.app", "http://localhost:5173", "https://heat-mitigation-coderss.onrender.com"],
    allow_methods=["*"],
    allow_headers=["*"],
)
